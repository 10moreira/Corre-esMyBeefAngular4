...
import { MenuComponent } from './bootstrap/menu/menu.component';
import {SimulacaoService} from "./services/simulacao.service";
import { SimulacaoListComponent } from './simulacao-list/simulacao-list.component';
import { SimulacaoSaveComponent } from './simulacao-save/simulacao-save.component';
import { HomeComponent } from './home/home.component';
import {HomeService} from "./services/home.service";
import { CarouselComponent } from './bootstrap/carousel/carousel.component';
import { ConhecamybeefComponent } from './conhecamybeef/conhecamybeef.component';
...
const appRoutes: Routes = [
   ...
   // {path: '', pathMatch: 'full', component: AtividadeListComponent},
    ...
    //{path: '', pathMatch: 'full', component: SimulacaoListComponent},
    {path: 'simulacao', component: SimulacaoListComponent},
    {path: 'simulacao/create', component: SimulacaoSaveComponent,},
    {path: 'simulacao/:id/edit', component: SimulacaoSaveComponent,},


    {path: '', pathMatch: 'full', component: HomeComponent},
    {path: 'home', component: HomeComponent},

    {path: 'conhecamybeef', component: ConhecamybeefComponent},
...
@NgModule({
  declarations: [
    ...
    MenuComponent,
    SimulacaoListComponent,
    SimulacaoSaveComponent,
    HomeComponent,
    CarouselComponent,
    ConhecamybeefComponent,
  ],
  imports: [
    BrowserModule,
  ...
  providers: [CategoriaanimalService, ConhecamybeefComponent, HomeService, SimulacaoService, MedidaService, ReceitaService, UsuarioService, PropriedadeService, RebanhoService, CustoService, AtividadeService, MessageService],
